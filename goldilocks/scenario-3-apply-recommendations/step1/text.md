...
The full stack is prepared automatically and this step only opens once both VPAs report a
recommendation — so the values below are ready to read as soon as you arrive.
